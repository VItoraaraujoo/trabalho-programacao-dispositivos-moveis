...
Os projetos implementados estão em `parte1-dart/` e `parte2-flutter/`. A Parte 1 imprime o relatório dos quatro primeiros exercícios; a Parte 2 usa as mesmas classes para exibir o cardápio, navegar para o detalhe, cadastrar um lanche e atualizar o estado da lista.

### Tabela de rastreio da implementação
...
| 5 | Estrutura de tela | `parte2-flutter/lib/screens/home_page.dart:108` | `Scaffold`, `AppBar`, chamada da casa e total |
| 6 | Cartão | `parte2-flutter/lib/screens/widgets/cartao_lanche.dart:33` | Cada lanche aparece como cartão de cardápio |
| 7 | Lista | `parte2-flutter/lib/screens/home_page.dart:289` | `ListView.builder` mostra seis opções ao abrir |
| 8 | Navegação | `parte2-flutter/lib/screens/home_page.dart:297` | Toque no cartão abre o detalhe do lanche |
| 9 | Formulário | `parte2-flutter/lib/screens/cadastro_page.dart:108` | Três campos controlados e botão de confirmação |
| 10 | Estado | `parte2-flutter/lib/screens/home_page.dart:92` | Lanche novo aparece e o total é recalculado |

> Antes da entrega, substitua o campo de integrante(s) pelos nomes corretos e atualize as linhas da tabela se o código for alterado.
